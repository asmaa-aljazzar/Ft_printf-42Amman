...
int ft_format_type(const char *format, int *i, va_list args, int printed_chars);
...
int ft_per_or_not_format(const char *format, int *i,va_list args, int printed_chars);
